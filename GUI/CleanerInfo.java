...
public class CleanerInfo extends JFrame implements  MouseListener, ActionListener
{
	...
	public void actionPerformed(ActionEvent ae) 
	{
		...
		if(!isAnyDataEmpty() && !isAllDataEmpty()){
			if(m.getEmployeeLeft() > 0){
				...
				Cleaner c1=new Cleaner(textfield1,textfield2,textfield3,textfield4);
				m.addEmployee(c1);
	...
	public void mouseExited(MouseEvent me)
	{
		...
		title = new JLabel("Cleaner's Information");
		title.setBounds(420, 30, 380, 25);
		...
		JLabel name1 = new JLabel("Cleaner's Name: ");
		name1.setFont(font);
		name1.setBounds(90, 100, 200, 25);
		panel.add(name1);
		...
		JLabel nid1 = new JLabel("Cleaner's NID: ");
		nid1.setFont(font);
		nid1.setBounds(110, 150, 200, 25);
		panel.add(nid1);
		...
		addData = new JButton("Add Cleaner");
