...
public class WaiterInfo extends JFrame implements MouseListener, ActionListener 
{
	...
	public void actionPerformed(ActionEvent ae) 
	{
		...
		if(!isAnyDataEmpty() && !isAllDataEmpty()){
			if(m.getEmployeeLeft() > 0){
				...
				Waiter c1=new Waiter(textfield1,textfield2,textfield3,textfield4);
				m.addEmployee(c1);
	...
	public void mouseExited(MouseEvent me)
	{
	  ...
	  public void initializeForm() {
		...
		title = new JLabel("Waiter's Information");
		title.setBounds(430, 30, 380, 25);
		...
		JLabel name1 = new JLabel("Waiter's Name: ");
		name1.setFont(font);
		name1.setBounds(100, 100, 200, 25);
		panel.add(name1);
		...
		JLabel nid1 = new JLabel("Waiter's NID: ");
		nid1.setFont(font);
		nid1.setBounds(120, 150, 200, 25);
		panel.add(nid1);
		...
		addData = new JButton("Add Waiter");
